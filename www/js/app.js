...
/***/ (function(module, exports, __webpack_require__) {
	...
	angular.module('app', ['ionic', 'ionic-material', 'ionMdInput', 'ion-floating-menu', 'angularPayments', _ngopenfb2.default, _core2.default, _common2.default, _login2.default, _profile2.default, _friends2.default, _activity2.default, _gallery2.default, _userProfile2.default, _search2.default, _rating2.default, _cart2.default, _about2.default, _product2.default, _brewery2.default, _payment2.default]).run(function ($window, ngFB) {
	    ...
	    filepicker.setKey('AE1tUr9TBSt29pm1Sfemkz');
	...
	var commonSvc = function () {
	    ...
	    _createClass(commonSvc, [{
	        ...
	        value: function getCartItems() {
	            ...
	            var cart = JSON.parse(localStorage.getItem('cart' + localStorage.getItem('profileId')));
	        ...
	        key: 'setCartItems',
	        value: function setCartItems(cart) {
	            localStorage.setItem('cart' + localStorage.getItem('profileId'), JSON.stringify(cart));
	        }
	    }, {
	        key: 'getTotalCart',
	        value: function getTotalCart(cart) {
	            return cart.items.map(function (p) {
	        ...
	        value: function addToCart(product) {
	            ...
	            var foundItem = cart.items.find(function (p) {
	        ...
	        value: function removeFromCart(id) {
	            var cart = this.getCartItems();
	            var index = cart.items.findIndex(function (p) {
	                return p._id === id;
	            });
...
/***/ (function(module, exports) {
	...
	function LoginCtrl($scope, $timeout, $stateParams, ionicMaterialInk, ngFB, $state, SERVER) {
	    ...
	    function fbLogin() {
	        ...
	        ngFB.login({ scope: 'email, publish_actions, user_friends' }).then(function (response) {
...
/***/ (function(module, exports) {
	...
	function FriendsCtrl($scope, $stateParams, $timeout, ionicMaterialInk, ionicMaterialMotion, ngFB, $state) {
	    ...
	    function loadFriends() {
	        ...
	        var url = 'https://graph.facebook.com/me/friends?access_token=' + userToken;
	        try {
	            fetch(url, {
	                method: 'GET'
	            }).then(function (response) {
	...
	var UserProfileCtrl = function () {
	    ...
	    _createClass(UserProfileCtrl, [{
	        ...
	        value: function loadUser() {
	            ...
	            var userToken = localStorage.getItem('token');
	            var url = 'https://graph.facebook.com/me?fields=id%2Cname%2Cfirst_name%2Clast_name%2Cage_range%2Clink%2Cgender%2Clocale%2Cpicture%2Ctimezone%2Cupdated_time%2Cverified%2Ceducation%2Cabout%2Cemail%20&access_token=' + userToken;
	            try {
	                fetch(url, {
	                    method: 'GET'
	                }).then(function (response) {
	                    ...
	                    _this.user = result;
	                    localStorage.setItem('profileId', _this.user.id);
	...
	var CartCtrl = function () {
	    ...
	    _createClass(CartCtrl, [{
	        ...
	        value: function loadCartItems() {
	            var cart = this.commonSvc.getCartItems();
	            this.cart = cart;
	        ...
	        key: 'minusOne',
	        value: function minusOne(id) {
	            var cart = this.commonSvc.minusOne(id);
	            this.cart = cart;
	        }
	    }, {
	        key: 'plusOne',
	        value: function plusOne(id) {
	            var cart = this.commonSvc.plusOne(id);
	            this.cart = cart;
	        }
	    }, {
	        key: 'removeFromCart',
	    ...
	    _createClass(PaymentCtrl, [{
	        ...
	        value: function submit() {
	            ...
	            new Promise(function (resolve) {
	                ...
	                _this2.commonSvc.cleanupCart();
	                _this2.$state.go('app.activity');
	            });
	        }
	    }, {
	        key: 'goCart',
